...
std::string create_pipeline_string(std::string codec)
{
    ...
    if (codec == "h265")
    {
        config_file_path = "/home/root/apps/encoder_pipelines_new_api/configs/encoder_sink_4k_h265.json";
        output_format = "hevc";
    }
    else
    {
        config_file_path = "/home/root/apps/encoder_pipelines_new_api/configs/encoder_sink_4k_h264.json";
        output_format = "h264";
    }
